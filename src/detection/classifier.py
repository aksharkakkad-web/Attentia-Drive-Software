...
class DistractionClassifier(BaseDetector):
    ...
    def __init__(self, config: ClassifierConfig) -> None:
        ...
        self._cached_result: ClassifierResult = ClassifierResult(distracted_probability=0.0)
    ...
    def detect(self, frame: np.ndarray) -> ClassifierResult:
        ...
        if frame_skip > 1 and self._frame_count != 1 and self._frame_count % frame_skip != 1:
        ...
        try:
            ...
            result = ClassifierResult(distracted_probability=probability, raw_logits=raw_logits)
